...
def generate_pdf(
    ...
    temp_dir = 'temp'
    data_dir = f'{subid}_generated'
    render_dir = 'renders'
    pdf_name = f'{subid}.pdf'

    data_dir = os.path.join(temp_dir, data_dir)
    ...
    try:
        ...
        shutil.copy(form_data_path, data_dir)
        shutil.copy(form_submit_data_path, data_dir)

        index_html_path = os.path.join(os.getcwd(), data_dir, 'index.html')
