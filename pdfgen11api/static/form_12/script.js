...
// http://127.0.0.1:8000/static/form_12/index.html?record_id=12345
...
function renderHTML() {
  const { record_id } = getQueryParams();
  ...
  const formDataPath = `./form_layout.json`;
  const formSubmitDataPath = `./data/${record_id}.json`;
